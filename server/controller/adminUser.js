...
const {service, settings, validatorUtil, siteFunc} = require('../../utils');
...
function checkFormData(req, res, fields) {
  ...
  console.log(fields.passwordConfirmed)
  if (fields.password !== fields.passwordConfirmed) {
    errMsg = '两次输入密码不一致!';
  }
  if (!validatorUtil.checkMobile(fields.mobile)) {
